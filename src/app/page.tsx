...
export default function Home() {
  return (
    <main className="relative min-h-screen w-full overflow-x-hidden overflow-y-auto flex flex-col items-center justify-start pt-8 px-4 md:justify-center md:p-4">
      {/* Dynamic Background */}
      <div
